...
function generer() {
    ...
    //trace 0
    let inpttext0 = insertingContainer.appendChild(document.createElement("katex"));
    let inpt0 = insertingContainer.appendChild(document.createElement("input"));
    ...
    //trace 1
    let espace1 = insertingContainer.appendChild(document.createElement("br"));
    let inpttext1 = insertingContainer.appendChild(document.createElement("katex"));
    let inpt1 = insertingContainer.appendChild(document.createElement("input"));
    ...
    //trace 2
    let espace2 = insertingContainer.appendChild(document.createElement("br"));
    let inpttext2 = insertingContainer.appendChild(document.createElement("katex"));
    let inpt2 = insertingContainer.appendChild(document.createElement("input"));
